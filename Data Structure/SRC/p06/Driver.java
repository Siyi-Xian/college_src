...
public class Driver {
	...
	public static void sendTweet(String message, boolean forReal) {
		message += "Hello World!" + Constants.HASHTAG;
		if (!forReal)
	...
	public static void tweetsAbout(String subject, boolean forReal) {
		if (!forReal)
			...
			// wanted.
			// query.setGeoCode(new GeoLocation(39.22031, -86.45824), 50,
			// Query.MILES);
