...
pca = prcomp(A)
# Draw plot
plot(pca$x[,1:2], main = "Scatter Plot")
...
# minus one becasue when adding the last ellments, the threshold will go out of bound!
i = i - 1
