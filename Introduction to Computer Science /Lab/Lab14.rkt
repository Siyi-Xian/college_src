...
(define w2 (make-w (/ HEIGHT 2) (/ HEIGHT 2) (/ WIDTH 2) (/ HEIGHT 2) VELOCITY VELOCITY))
(define w3 (make-w (/ HEIGHT 2) (/ HEIGHT 2) (/ WIDTH 2) (/ HEIGHT 2) VELOCITY VELOCITY))
(define w4 (make-w (/ HEIGHT 2) (/ HEIGHT 2) (/ WIDTH 2) (/ HEIGHT 2) VELOCITY VELOCITY))
...
(define (move-ball w)
  (cond[(or (<= (w-bx w) LEFT) (>= (w-bx w) RIGHT))
       ...
       [(or (<= (w-by w) TOP) (>= (w-by w) BOTTOM))
        (make-w (w-p1 w) (w-p2 w) (+ (w-bx w) VELOCITY) (- (w-by w) VELOCITY) (w-dx w) (- (w-dy w)))]
