...
if __name__ == '__main__':
    loader = Loader()
    scale_X, scale_y = loader._import_data('scale_transformed.csv','/Users/xiansiyi/Box Sync/Siyi Xian/College/18FA/CSCI-B 351/siyixian-submission/a5/datasets/')
    voting_X, voting_y = loader._import_data('voting_transformed.csv','/Users/xiansiyi/Box Sync/Siyi Xian/College/18FA/CSCI-B 351/siyixian-submission/a5/datasets/')
    ...
    test = loader.load_data('scale_transformed.csv','/Users/xiansiyi/Box Sync/Siyi Xian/College/18FA/CSCI-B 351/siyixian-submission/a5/datasets/')
